...
def mock_get_chart(mock_chart):
    ...
    patches = [
        patch("handlers.publish.get_chart", return_value=mock_chart),
        patch("handlers.retrieve.get_chart", return_value=mock_chart),
        patch("handlers.update.get_chart", return_value=mock_chart),
        patch("handlers.delete.get_chart", return_value=mock_chart),
        patch("handlers.export.get_chart", return_value=mock_chart),
    ]
...
def mock_bar_chart_class():
    ...
    with patch("config.BarChart") as mock_class:
